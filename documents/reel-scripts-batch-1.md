...
| 4/5 | Click the page like they would. | `4/5  Click it like the owner would` |
| 5/5 | Hold the shop name | `5/5  Comment your city` |

**Record (6 min):** reuse Tuesday’s `shop.html`, change the name. Do not remake the debugger post.

**Caption:**

```
This 4-step roadmap that gets you a real user.

Pick a place you can walk to. Put their name on one page. Write the ask. Click it like the owner would.

The feed is internships or founders. The middle is a real user.

Comment your city.

#freshers #offcampus #engineeringstudents #aitools #chennai
```
