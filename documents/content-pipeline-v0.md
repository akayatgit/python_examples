# Content Pipeline v0 — Akay / career_with_akay
...
Account baseline (31 Aug 2026): August interview/job posts live at **300–1,600 plays**. July TNEA utility hit **3k–33k**. The 10k bar is “return to utility-hit range, every week,” not “go viral once.”
...
**Name:** Ashok K  
**Username:** stay `career_with_akay`

**Bio (replace today’s job-alert + scholarship bio):**
...
## 3. The five templates (this is the pipeline)
...
## 7. Review loop (the factory)

Every Sunday, 20 minutes, before you write the next 5:
...
## 8. What we will not post (phase lock)
...
## 9. When selling turns on

Only after **all** of these are true:

1. Pipeline bar passed (10/10 on time).
2. Reach bar passed (4/5 ≥ 10k views).
3. Skip rate on those 4 ≤ 45%.
4. We have 3 Reels that people **save** (saves ≥ 1% of views) — that is the product clue.

Then — and only then — we ship the ₹499 kit behind a keyword. Not before.
